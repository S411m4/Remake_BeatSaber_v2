...
public class Lighsaber : MonoBehaviour
{
    ...
    public class onAnyCutEventArgs:EventArgs { public GameObject cube; public GameObject saber; }
    ...
    [SerializeField] private int layerNo;
    ...
    {
        if (other.gameObject.layer != layerNo)
        {
            _triggerEnterTipPosition = _tip.transform.position;
            _triggerEnterBasePosition = _base.transform.position;
            onAnyCut?.Invoke(this, new onAnyCutEventArgs { cube = other.gameObject, saber= this.gameObject});
        }
    }
